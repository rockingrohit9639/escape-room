...
const SidebarContext = createContext<SidebarContextDef | null>(null)
...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const contextValue = useMemo<SidebarContextDef>(
    () => ({
      state,
      open,
      setOpen,
...
const SidebarGroupLabel = forwardRef<HTMLDivElement, React.ComponentProps<'div'> & { asChild?: boolean }>(
...
const SidebarGroupAction = forwardRef<HTMLButtonElement, React.ComponentProps<'button'> & { asChild?: boolean }>(
  ({ className, asChild = false, ...props }, ref) => {
...
const SidebarGroupContent = forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
...
const SidebarMenuBadge = forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
