import { baseObject } from '@escape-room/contracts'
  ...
  return (
    <>
      ...
      <FormField
        ...
        name="disabled"
        render={({ field }) => (
          <FormItem className="flex items-center gap-2 justify-between rounded-md border p-3 shadow-sm">
            <FormLabel htmlFor="disabled" className="cursor-pointer space-y-0.5">
              <p>Disabled</p>
              <FormDescription>Setting this to true will disable all the interactions</FormDescription>
            </FormLabel>
            <FormControl>
        ...
        render={({ field }) => (
          <FormItem className="flex items-center gap-2 justify-between rounded-md border p-3 shadow-sm">
            <FormLabel htmlFor="isDroppable" className="cursor-pointer space-y-0.5">
              <p>Droppable</p>
              <FormDescription>User can drop other objects on this object if enabled.</FormDescription>
            </FormLabel>
            <FormControl>
